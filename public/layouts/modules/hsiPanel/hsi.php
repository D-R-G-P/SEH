...
<div class="content">
  ...
  <div class="modulo">
    ...
    <div class="inlineDiv">
      <button class="btn-green" onclick="newUser()"><i class="fa-solid fa-plus"></i> Solicitar nuevo usuario</button>
    </div>
        ...
        <table id="news">
          ...
          <tbody>
            ...
            if ($stmtNews->rowCount() == 0) {
              ...
              echo '<tr><td colspan="7">No hay notificaciones pendientes</td></tr>';
            } else {
          ...
          <tbody>
            ...
            if ($stmtWorking->rowCount() == 0) {
              ...
              while ($rowWorking = $stmtWorking->fetch(PDO::FETCH_ASSOC)) {
                ...
                echo '<td class="table-left table-middle" style="width: max-content;">';
                ...
                if ($permisosWorking_array !== null) {
                  ...
                  foreach ($permisosWorking_array as $permisoWorking) {
                    ...
                    if ($activo == "si") {
                      $permisos_activos[] = '<div style="display: flex; width: max-content; align-items: center;"><i class="fa-solid fa-chevron-right"></i> ' . $nombre_permiso;
                    }
                  }
                ...
                if ($documentos_array !== null) {
                  ...
                  foreach ($documentos_array as $documentoWorking) {
                    ...
                    switch ($documento) {
                      case 'Copia de DNI':
                        $documento_nombre = 'DNI';
                        break;
                      case 'Copia de matrícula profesional':
                        $documento_nombre = 'M.P';
                        break;
                    ...
                    $simbolo = ($activo == "si") ? '<i class="fa-solid fa-circle-check"></i>' : '<i class="fa-solid fa-circle-xmark"></i>';

                    

                    echo '<div style="display: flex; width: max-content; align-items: center;">'. $documentos_activos[] = '<i class="fa-solid fa-chevron-right"></i> ' . $documento_nombre . ': ' . $simbolo .'</div>';

                  }
                  // echo implode('<br>', $documentos_activos);
                }
                echo '</td>';

                echo '<td class="table-center table-middle">a</td>';
