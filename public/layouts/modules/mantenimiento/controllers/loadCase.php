        ...
        foreach ($resultados as $fila) {
            ...
            <div class="close" style="width: 100%; display: flex; justify-content: flex-end; padding: .5vw; margin-top: 17vw;">
                <button class="btn-red"
                    onclick="back.style.display = 'none'; infoCaseBase.style.display = 'none'; document.querySelectorAll(form).reset(); $('#solicitudServicio').val(null).trigger('change');"
                ...
                <div class="left" style="margin-right: 1vw;">
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td colspan="2">
                                    <?= htmlspecialchars($fila['short_description'] ?? 'Sin descripción breve') . ' - ' . htmlspecialchars($fila['long_description'] ?? 'Sin descripción detallada') ?>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="table-center table-middle">
                                    ...
                                    <?php if (!$gestionMode && $fila['estado_reclamante'] != "Completado") { ?>
                                        <form action="controllers/procesar_estado.php" method="post"
                                            style="display: flex; margin: 0; width: 100%; align-items: center;">
                                            <input type="hidden" name="id" value="<?= htmlspecialchars($fila['id']) ?>">
                                            <input type="hidden" name="sender" value="reclamante">
                                            <select id="estado" name="estado"
                                                onchange="document.getElementById('state_reclamante').style.display = 'inline-block'; finished(this.value);">
                                                ...
                                                <option class="completado" value="Completado"
                                                    <?= $fila['estado_reclamante'] === 'Completado' ? 'selected' : '' ?>>Completado
                                                </option>
                                                <option class="rechazado" value="Rechazado" <?= $fila['estado_reclamante'] === 'Rechazado' ? 'selected' : '' ?>>Rechazado</option>
                                                <option class="programado" value="Programado"
                                                    <?= $fila['estado_reclamante'] === 'Programado' ? 'selected' : '' ?>>Programado
                                                </option>
                                            </select>
                                            <button title="Guardar" id="state_reclamante" type="submit" class="btn-green"
                            ...
                            <tr>
                                ...
                                <?php if (!$gestionMode && $fila['estado_reclamante'] != "Completado") { ?>
                                    <td colspan="2">
                                        <form action="controllers/procesar_observaciones.php" method="post"
                                            style="height: auto; width: 100%;">
                                            <input type="hidden" name="id" value="<?= htmlspecialchars($fila['id']) ?>">
                                            <input type="hidden" name="sender" value="reclamante">
                                            <div style="display: flex; flex-direction: row;">
                                                <textarea oninput="obs_reclamante.style.display = 'block';" name="observaciones"
                                                    id="observaciones_reclamante" style="width: 100%; height: 5vw; resize: none;"
                                                    placeholder="Escribe aquí la observación que consideres..."><?= htmlspecialchars($fila['observaciones_reclamante']) ?></textarea>

                                                <button title="Guardar" style="margin: 0 0 0 .3vw; display: none;" id="obs_reclamante"
                                                    type="submit" class="btn-green"><i class="fa-solid fa-floppy-disk"></i></button>
                                            </div>
                                        </form>
                                    </td>
                                <?php } else { ?>
                ...
                <div class="right">
                                ...
                                if (
                                    ...
                                    <td colspan="2">
                                        <form action="controllers/procesar_observaciones.php" method="post"
                                            ...
                                            <div style="display: flex; flex-direction: row;">
                                                <textarea oninput="obs_destino.style.display = 'block';" name="observaciones"
                                                    id="observaciones_destino" style="width: 100%; height: 5vw; resize: none;"
                                                    placeholder="Escribe aquí la observación que consideres..."><?= htmlspecialchars($fila['observaciones_destino']) ?></textarea>

                                                <button title="Guardar" style="margin: 0 0 0 .3vw; display: none;" id="obs_destino"
                                                    type="submit" class="btn-green"><i class="fa-solid fa-floppy-disk"></i></button>
                                            </div>
                                        </form>
                                    </td>
                                <?php } else { ?>
                                    <td colspan="2"><?= htmlspecialchars(trim($fila['observaciones_destino']) ?: 'Sin observaciones') ?>
                                    </td>
                                <?php } ?>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <?php if (
                                        ...
                                        <form action="controllers/procesar_estado.php" method="post"
                                            ...
                                            <input type="hidden" name="sender" value="destino">
                                            <select id="estado" name="estado"
                                                onchange="document.getElementById('state_destino').style.display = 'inline-block';">
                                            ...
                                            <button title="Guardar" id="state_destino" type="submit" class="btn-green"
                                                style="display: none; margin-left: 10px;">
                                                <i class="fa-solid fa-floppy-disk"></i>
                                            </button>
                                        </form>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    if ($gestionMode && ($fila['estado_reclamante'] !== "Completado" && $fila['estado_destino'] !== "Completado")) { ?>
                                        <button class="btn-yellow" title="Marcar para auditar" style="padding: .5vw;"
                                            onclick="audit(<?= htmlspecialchars($fila['id']); ?>);"><i
                                                class="fa-solid fa-circle-exclamation" style="font-size: 1vw;"></i></button>
                                    <?php } ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if (hasAccess(['direccion', 'administrador']) && $gestionMode || hasSubAccess(['auditoria']) && $gestionMode) { ?>
                                            <form action="controllers/audit.php" method="post"
                                                ...
                                                <button type="submit" class="btn-green" id="auditSave"
                    ...
                    <?php if (hasAccess(['administrador', 'direccion'])) { ?>
                        <table style="margin-top: .5vw;">
                            ...
                            <tbody>
                                <tr>
                                    <td colspan="2" class="table-center"><b>Primer acceso</b></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td colspan="2" class="table-center"><b>Último acceso</b></td>
                                </tr>
                                <tr>
                                    <td><b>Fecha y hora</b></td>
